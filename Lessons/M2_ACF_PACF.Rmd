...
autoplot(ts_inflow_data[,1],series = "HP1") +
  autolayer(ts_inflow_data[,2],series = "HP2")+
  xlab("Time") +
  ylab("Inflow") +
  labs(color="Reservoir")
...
HP1_acf = acf(ts_inflow_data[,1],lag.max = 60,plot = TRUE)
...
HP1_acf = Acf(ts_inflow_data[,1],lag.max = 60)
